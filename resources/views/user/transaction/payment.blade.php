            ...
            <div class="flex flex-col items-start col-span-6 gap-y-10 pr-5 border-r-2 border-[#DDDDDE]">
                <div class="flex flex-col w-full gap-y-8">
                    ...
                    <div class="flex items-center border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] pl-5">
                        <input id="cc" type="radio" value="" name="payment_id"
                    ...
                    <div class="flex flex-col gap-y-4">
                        <div
                            ...
                            <div class="flex items-center gap-x-5">
                                <input id="va_bca" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
                        ...
                        <div
                            class="flex items-center justify-between border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] px-5">
                            <div class="flex items-center gap-x-5">
                                <input id="va_bni" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
                        ...
                        <div
                            class="flex items-center justify-between border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] px-5">
                            <div class="flex items-center gap-x-5">
                                <input id="va_mandiri" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
                ...
                <div class="flex flex-col w-full gap-y-8">
                    ...
                    <div class="flex flex-col gap-y-4">
                        <div
                            class="flex items-center justify-between border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] px-5">
                            <div class="flex items-center gap-x-5">
                                <input id="em_gopay" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
                        ...
                        <div
                            class="flex items-center justify-between border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] px-5">
                            <div class="flex items-center gap-x-5">
                                <input id="em_ovo" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
                        ...
                        <div
                            class="flex items-center justify-between border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] px-5">
                            <div class="flex items-center gap-x-5">
                                <input id="em_linkaja" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
                        ...
                        <div
                            class="flex items-center justify-between border-2 rounded-md gap-x-4 border-[#DDDDDE] py-[10px] px-5">
                            <div class="flex items-center gap-x-5">
                                <input id="em_shopeepay" type="radio" value="" name="payment_id"
                                    class="w-4 h-4 bg-gray-100 border-gray-300 text-purple focus:ring-purple focus:ring-2">
