    ...
    <section class="mx-auto max-w-7xl border-b border-[#DDDDDE] pt-10 pb-[200px]">
        <div class="w-[1000px] mx-auto flex flex-col items-center">
            <div class="px-10 py-[10px] rounded-md border-purple border-4 relative bg-white mb-4">
                <p class="font-display text-[48px] text-purple font-bold text-center">Completed!</p>
            ...
            <p class="font-sans text-xl font-semibold text-center text-purple mb-[60px]">rachelgreen@gmail.com</p>
            <p class="mb-5 font-sans text-[16px] font-semibold text-center text-dark">Haven’t received tickets yet?</p>
            <button class="text-purple py-[10px] px-4 rounded-md border-2 border-purple font-sans text-sm mb-[110px]">
                Resend Tickets
            </button>
