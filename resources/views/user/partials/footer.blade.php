...
<footer class="mx-auto max-w-[1440px] bg-purple">
    <div class="grid grid-cols-5 gap-x-[52px] pt-[60px] pb-10 px-[120px] border-b border-[#DDDDDE]">
        <p class="font-displat font-bold text-white text-[30px] -mt-2">Karcis.com</p>
        <div class="flex flex-col font-sans text-white">
            <p class="mb-3 text-xl font-medium">About</p>
            <div class="flex flex-col gap-y-2">
                <p class="text-[16px] font-normal">About Karcis.com</p>
                <p class="text-[16px] font-normal">How it Works</p>
                <p class="text-[16px] font-normal">Careers</p>
                <p class="text-[16px] font-normal">Press</p>
                <p class="text-[16px] font-normal">Blog</p>
                <p class="text-[16px] font-normal">Forum</p>
            </div>
        </div>
        <div class="flex flex-col font-sans text-white">
            <p class="mb-3 text-xl font-medium">Partner with us</p>
            <div class="flex flex-col gap-y-2">
                <p class="text-[16px] font-normal">Partnership Program</p>
                <p class="text-[16px] font-normal">Affilate Program</p>
                <p class="text-[16px] font-normal">Connectivity Partners</p>
                <p class="text-[16px] font-normal">Promotions and Events</p>
                <p class="text-[16px] font-normal">Integrations</p>
                <p class="text-[16px] font-normal">Community</p>
                <p class="text-[16px] font-normal">Loyalty Program</p>
            </div>
        </div>
        <div class="flex flex-col font-sans text-white">
            <p class="mb-3 text-xl font-medium">Support</p>
            <div class="flex flex-col gap-y-2">
                <p class="text-[16px] font-normal">Help Center</p>
                <p class="text-[16px] font-normal">Contact Us</p>
                <p class="text-[16px] font-normal">Privacy Policy</p>
                <p class="text-[16px] font-normal">Terms of service</p>
                <p class="text-[16px] font-normal">Trust and safety</p>
                <p class="text-[16px] font-normal">Accessibility</p>
            </div>
        </div>
        <div class="flex flex-col font-sans text-white">
            <p class="mb-3 text-xl font-medium">Get The App</p>
            <div class="flex flex-col gap-y-2">
                <p class="text-[16px] font-normal">Karcis.com for Android</p>
                <p class="text-[16px] font-normal">Karcis.com for iOS</p>
                <p class="text-[16px] font-normal">Mobile Site</p>
            </div>
        </div>
    </div>
    <div class="flex items-center justify-between px-[120px] py-[30px]">
        ...
        <p class="font-sans text-lg text-white">&copy 2023 Karcis Incorporated</p>
    </div>
</footer>
<!-- Footer Section End -->
