        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="mb-8">Create Ticker for Event <span
                            class="font-medium uppercase">{{ $event->name }}</span></h1>
                    <form action="{{ route('admin.tickets.store', $event->slug) }}" method="post">
                        @csrf
                        <div class="grid grid-cols-1 mb-8 md:grid-cols-3 gap-x-4 gap-y-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="price" name="price" type="number"
                                    class="block w-full mt-1 text-sm" :value="old('price')" autofocus
                                    autocomplete="price" />
                            ...
                            <div>
                                ...
                                <x-text-input id="quota" name="quota" type="number"
                                    class="block w-full mt-1 text-sm" :value="old('quota')" autofocus
                                    autocomplete="quota" />
