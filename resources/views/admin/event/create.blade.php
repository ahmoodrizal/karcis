        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="mb-4 font-medium uppercase">Create New Event</h1>
                        ...
                        <div class="grid grid-cols-1 gap-5 mb-10 sm:grid-cols-3">
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text"
                                    class="block w-full mt-1 text-sm" :value="old('name')" autofocus autocomplete="name" />
                                <x-input-error class="mt-2" :messages="$errors->get('name')" />
                            </div>
                            <div>
                                <x-input-label for="location" :value="__('Location')" />
                                <x-text-input id="location" name="location" type="text"
                                    class="block w-full mt-1 text-sm" :value="old('location')" autocomplete="location" />
                                <x-input-error class="mt-2" :messages="$errors->get('location')" />
                            </div>
                            <div>
                                <x-input-label for="city" :value="__('City')" />
                                <x-text-input id="city" name="city" type="text"
                                    class="block w-full mt-1 text-sm" :value="old('city')" autocomplete="city" />
                            ...
                            <div class="">
                                ...
                                <x-text-input id="audience" name="audience" type="text"
                                    class="block w-full mt-1 text-sm" :value="old('audience')" autocomplete="audience" />
                            ...
                            <div class="">
                                ...
                                <x-text-input id="attention" name="attention" type="text"
                                    class="block w-full mt-1 text-sm" :value="old('attention')" autocomplete="attention" />
